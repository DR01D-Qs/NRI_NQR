...
function CharacterTweakData:_presets(tweak_data)
	...
	presets.hurt_severities.no_hurts = {
		bullet = { health_reference = 1, zones = { { none = 1 } } },
		explosion = { health_reference = 1, zones = { { none = 1 } } },
		melee = { health_reference = 1, zones = { { none = 1 } } },
		fire = { health_reference = 1, zones = { { none = 1 } } },
		poison = { health_reference = 1, zones = { { none = 1 } } }
	}

	presets.hurt_severities.only_light_hurt = {
		bullet = { health_reference = "current", zones = { { health_limit = 0.3, light = 1, none = 0 }, { light = 1 } } },
		explosion = { health_reference = "current", zones = { { none = 0.4, light = 0.6, health_limit = 0.3 }, { explode = 1 } } },
		melee = { health_reference = "current", zones = { { none = 0.4, light = 0.6, health_limit = 0.3 }, { light = 1 } } },
		fire = { health_reference = 1, zones = { { light = 1 } } },
		poison = { health_reference = 1, zones = { { none = 1 } } }
	}

	--[[240.3
	presets.hurt_severities.only_light_hurt_and_fire = {
		bullet = { health_reference = 1, zones = { { light = 1 } } },
		explosion = { health_reference = 1, zones = { { explode = 1 } } },
		melee = { health_reference = 1, zones = { { light = 1 } } },
		fire = { health_reference = 1, zones = { { fire = 1 } } },
		poison = { health_reference = 1, zones = { { none = 1 } } }
	}

	presets.hurt_severities.light_hurt_fire_poison = deep_clone(presets.hurt_severities.only_light_hurt_and_fire)
	presets.hurt_severities.light_hurt_fire_poison.poison = { health_reference = 1, zones = { { poison = 1 } } }
	]]
	presets.hurt_severities.only_poison_and_light_hurt = deep_clone(presets.hurt_severities.only_light_hurt)
	presets.hurt_severities.only_poison_and_light_hurt.poison = { health_reference = 1, zones = { { poison = 1 } } }

	presets.hurt_severities.only_explosion_and_light_hurt = {
		bullet = { health_reference = "current", zones = {
			{ health_limit = 0.3, light = 0.6, none = 0.4 },
			{ light = 1 } } },
		explosion = { health_reference = "current", zones = { { explode = 1 } } },
		melee = { health_reference = "current", zones = {
			{ health_limit = 0.3, light = 0.6, none = 0.4 },
			{ light = 1 } } },
		fire = { health_reference = 1, zones = { { none = 1 } } },
		poison = { health_reference = 1, zones = { { none = 1 } } }
	...
	presets.hurt_severities.only_fire_and_poison_hurts = {
		...
		melee = { health_reference = 1, zones = { { none = 1 } } },
		fire = { health_reference = 1, zones = { { fire = 1 } } },
		poison = { health_reference = 1, zones = { { poison = 1 } } }
	}
	]]

	presets.hurt_severities.base = {
		bullet = { health_reference = "current", zones = {
			{ health_limit = 0.3, heavy = 0.3, moderate = 0.7, light = 0.0, none = 0.0 },
			{ health_limit = 0.6, heavy = 0.5, moderate = 0.5, light = 0.0, none = 0.0 },
			{ health_limit = 0.9, heavy = 0.7, moderate = 0.3, light = 0.0, none = 0.0 },
			{ health_limit = 1.0, heavy = 0.9, moderate = 0.1, light = 0.0, none = 0.0 } } },
		explosion = { health_reference = "current", zones = {
			{ health_limit = 0.2, heavy = 0.4, moderate = 0.0, light = 0.0, none = 0.6 },
			{ health_limit = 0.5, heavy = 0.6, moderate = 0.0, light = 0.0, none = 0.0, explode = 0.4 },
			{ health_limit = 1.0, heavy = 0.2, moderate = 0.0, light = 0.0, none = 0.0, explode = 0.8 } } },
		melee = { health_reference = "current", zones = {
			{ health_limit = 0.3, heavy = 0.0, moderate = 0.0, light = 0.7, none = 0.3 },
			{ health_limit = 0.8, heavy = 0.0, moderate = 0.0, light = 1.0, none = 0.0 },
			{ health_limit = 0.9, heavy = 0.2, moderate = 0.2, light = 0.6, none = 0.0 },
			{ health_limit = 1.0, heavy = 1.0, moderate = 0.0, light = 0.0, none = 0.0 } } },
		fire = { health_reference = "current", zones = {
			{ none = 1 } } },
		poison = { health_reference = "current", zones = {
			{ poison = 1 } } },
	}
	presets.hurt_severities.heavy = {
		bullet = { health_reference = "current", zones = {
			{ health_limit = 0.3, heavy = 0.1, moderate = 0.3, light = 0.6, none = 0.0 },
			{ health_limit = 0.6, heavy = 0.2, moderate = 0.4, light = 0.4, none = 0.0 },
			{ health_limit = 0.9, heavy = 0.3, moderate = 0.5, light = 0.2, none = 0.0 },
			{ health_limit = 1.0, heavy = 0.4, moderate = 0.5, light = 0.1, none = 0.0 } } },
		explosion = { health_reference = "current", zones = {
			{ health_limit = 0.2, heavy = 0.4, moderate = 0.0, light = 0.0, none = 0.6 },
			{ health_limit = 0.5, heavy = 0.6, moderate = 0.0, light = 0.0, none = 0.0, explode = 0.4 },
			{ health_limit = 1.0, heavy = 0.2, moderate = 0.0, light = 0.0, none = 0.0, explode = 0.8 } } },
	...
	presets.hurt_severities.base_no_poison = deep_clone(presets.hurt_severities.base)
	presets.hurt_severities.base_no_poison.
		poison = { health_reference = 1, zones = {
			{ none = 1 } }
	}
	...
	presets.base = {
		HEALTH_INIT = 2.5,
		headshot_dmg_mul = 2,
		SPEED_WALK = { ntl = 120, cbt = 160, hos = 180, pnc = 160 },
		SPEED_RUN = 370,
		crouch_move = true,
		shooting_death = true,
		suspicious = true,
		surrender_break_time = { 20, 30 },
		submission_max = { 45, 60 },
		submission_intimidate = 15,
		speech_prefix = "po",
		speech_prefix_count = 1,
		rescue_hostages = true,
		...
		calls_in = true,
		ignore_medic_revive_animation = false,
		spotlight_important = false, experience = {} }
	presets.base.experience.cable_tie = "tie_swat"
	presets.base.damage = {
		hurt_severity = presets.hurt_severities.base,
		death_severity = 0.5, explosion_damage_mul = 1,
	...
	presets.weapon.normal.is_pistol = {
		aim_delay = { 0.2, 0.2 }, focus_delay = 2, focus_dis = 200, spread = 25, miss_dis = 30, RELOAD_SPEED = 0.9,
		melee_speed = 1, melee_dmg = 2, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.4, 0.8 }, recoil = { 0.4, 0.6 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.3 }, recoil = { 0.4, 1.0 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.normal.akimbo_pistol = {
		aim_delay = { 0.2, 0.2 }, focus_delay = 2, focus_dis = 200, spread = 20, miss_dis = 50, RELOAD_SPEED = 0.9,
		melee_speed = 1, melee_dmg = 2, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.9 }, recoil = { 0.1, 0.2 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.3 }, recoil = { 0.4, 1.0 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.normal.is_rifle = {
		aim_delay = { 0.2, 0.2 }, focus_delay = 2, focus_dis = 200, spread = 20, miss_dis = 40, RELOAD_SPEED = 0.9,
		melee_speed = 1, melee_dmg = 2, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, autofire_rounds = { 3, 5 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.2, 0.4 }, recoil = { 0.2, 0.4 }, mode = { 0, 1, 2, 8 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.1, 0.2 }, recoil = { 0.6, 1.2 }, mode = { 0, 1, 3, 2 } } } }
	presets.weapon.normal.is_bullpup = presets.weapon.normal.is_rifle
	presets.weapon.normal.is_shotgun_pump = {
		aim_delay = { 0.2, 0.2 }, focus_delay = 2, focus_dis = 200, spread = 15, miss_dis = 20, RELOAD_SPEED = 0.9,
		melee_speed = 1, melee_dmg = 2, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.9 }, recoil = { 1.0, 1.5 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.3 }, recoil = { 1.5, 2.0 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.normal.is_shotgun_mag = {
		aim_delay = { 0.5, 1 }, focus_delay = 2, focus_dis = 200, spread = 15, miss_dis = 20, RELOAD_SPEED = 0.5,
		melee_speed = 1, melee_dmg = 2, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 },
		FALLOFF = {
			{ dmg_mul = 1.0, r = 2000, acc = { 0.3, 0.7 }, recoil = { 0.2, 0.4 }, mode = { 1, 0, 0, 0 } },
			{ dmg_mul = 1.0, r = 3000, acc = { 0.2, 0.4 }, recoil = { 0.4, 0.8 }, mode = { 1, 0, 0, 0 } },
		}
	}
	presets.weapon.normal.is_smg = {
		aim_delay = { 0.5, 1.0 }, focus_delay = 2, focus_dis = 200, spread = 15, miss_dis = 10, RELOAD_SPEED = 1,
		melee_speed = 1, melee_dmg = 15, melee_retry_delay = { 1, 2 }, range = { optimal = 1000, far = 3000, close = 500 }, autofire_rounds = { 3, 8 },
		FALLOFF = {
			{ dmg_mul = 1.0, r = 1000, acc = { 0.1, 0.3 }, recoil = { 0.6, 1.2 }, mode = { 0, 0, 0, 1 } },
			{ dmg_mul = 1.0, r = 2000, acc = { 0.0, 0.2 }, recoil = { 1.0, 2.0 }, mode = { 0, 0, 0, 1 } }
		}
	}
	presets.weapon.normal.is_revolver = {
		aim_delay = { 0.2, 0.2 }, focus_delay = 2, focus_dis = 200, spread = 20, miss_dis = 50, RELOAD_SPEED = 0.9,
		melee_speed = 1, melee_dmg = 2, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.9 }, recoil = { 0.8, 1.0 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.3 }, recoil = { 1.0, 1.5 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.normal.mini = {
		aim_delay = { 0.2, 0.2 }, focus_delay = 2, focus_dis = 800, spread = 20, miss_dis = 40, RELOAD_SPEED = 0.5,
		melee_speed = 1, melee_dmg = 25, melee_retry_delay = { 1, 2 }, range = { optimal = 2500, far = 5000, close = 1000 }, autofire_rounds = { 20, 40 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.9 }, recoil = { 0.4, 0.7 }, mode = { 0, 0, 0, 1 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.1, 0.3 }, recoil = { 1.0, 1.2 }, mode = { 4, 2, 1, 0 } } } }
	presets.weapon.normal.is_lmg = {
		aim_delay = { 0.2, 0.2 }, focus_delay = 2, focus_dis = 200, spread = 24, miss_dis = 40, RELOAD_SPEED = 0.6,
		melee_speed = 1, melee_dmg = 2, melee_retry_delay = { 1, 2 }, range = { optimal = 1800, far = 5000, close = 800 }, autofire_rounds = { 20, 40 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.5, 0.8 }, recoil = { 0.4, 0.8 }, mode = { 0, 0, 0, 1 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.3 }, recoil = { 1.5, 3.0 }, mode = { 0, 0, 0, 1 } } } }
	presets.weapon.normal.is_flamethrower = {
		aim_delay = { 0.5, 0.5 }, focus_delay = 1, focus_dis = 300, spread = 0, miss_dis = 40, RELOAD_SPEED = 0.6,
		melee_speed = 1, melee_dmg = 2, melee_retry_delay = { 1, 2 }, range = { optimal = 400, far = 1700, close = 1400 }, autofire_rounds = { 20, 40 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 1.0, 1.0 }, recoil = { 0.1, 0.2 }, mode = { 0, 0, 0, 1 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 1.0, 1.0 }, recoil = { 0.7, 1.0 }, mode = { 0, 0, 0, 1 } } }
	}

	presets.weapon.good = {}
	presets.weapon.good.is_pistol = {
		aim_delay = { 0.5, 1.0 }, focus_delay = 2, focus_dis = 200, spread = 25, miss_dis = 10, RELOAD_SPEED = 1,
		melee_speed = 1, melee_dmg = 15, melee_retry_delay = { 1, 2 }, range = presets.weapon.normal.is_pistol.range, FALLOFF = {
		{ dmg_mul = 1.0, r = 1000, acc = { 0.6, 0.9 }, recoil = { 0.4, 0.6 }, mode = { 0, 3, 3, 1 } },
		{ dmg_mul = 1.0, r = 2000, acc = { 0.1, 0.3 }, recoil = { 0.4, 1.0 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.good.akimbo_pistol = {
		aim_delay = { 0.1, 0.1 }, focus_delay = 2, focus_dis = 200, spread = 20, miss_dis = 50, RELOAD_SPEED = 1,
		melee_speed = 1, melee_dmg = 15, melee_retry_delay = { 1, 2 }, range = presets.weapon.normal.is_pistol.range, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.90 }, recoil = { 0.1, 0.2 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.35 }, recoil = { 0.4, 1.0 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.good.is_rifle = {
		aim_delay = { 1, 2 }, focus_delay = 3, focus_dis = 200, spread = 30, miss_dis = 10, RELOAD_SPEED = 1,
		melee_speed = 1, melee_dmg = 15, melee_retry_delay = { 1, 2 },
		range = { optimal = 2000, far = 5000, close = 1000 }, autofire_rounds = presets.weapon.normal.is_rifle.autofire_rounds,
		FALLOFF = {
			{ dmg_mul = 1.0, r = 1000, acc = { 0.3, 0.7 }, recoil = { 0.6, 1.2 }, mode = { 2, 2, 4, 1 } },
			{ dmg_mul = 1.0, r = 2000, acc = { 0.2, 0.4 }, recoil = { 1.2, 2.4 }, mode = { 4, 2, 2, 0 } }
		}
	}
	presets.weapon.good.is_bullpup = presets.weapon.good.is_rifle
	presets.weapon.good.is_shotgun_pump = {
		aim_delay = { 1.0, 1.5 }, focus_delay = 5, focus_dis = 200, spread = 15, miss_dis = 20, RELOAD_SPEED = 1,
		melee_speed = 1, melee_dmg = 15, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 1000, acc = { 0.6, 0.90 }, recoil = { 0.8, 1.2 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.35 }, recoil = { 1.2, 1.8 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.good.is_shotgun_mag = presets.weapon.good.is_shotgun_pump
	presets.weapon.good.is_smg = {
		aim_delay = { 0.5, 1.0 }, focus_delay = 2, focus_dis = 200, spread = 25, miss_dis = 10, RELOAD_SPEED = 1,
		melee_speed = 1, melee_dmg = 15, melee_retry_delay = { 1, 2 }, range = presets.weapon.normal.is_smg.range, autofire_rounds = presets.weapon.normal.is_smg.autofire_rounds,
		FALLOFF = {
			{ dmg_mul = 1.0, r = 1000, acc = { 0.2, 0.6 }, recoil = { 0.4, 0.8 }, mode = { 0, 0, 0, 1 } },
			{ dmg_mul = 1.0, r = 2000, acc = { 0.1, 0.3 }, recoil = { 0.8, 1.6 }, mode = { 0, 0, 0, 1 } }
		}
	}
	presets.weapon.good.is_revolver = {
		aim_delay = { 0.1, 0.1 }, focus_delay = 2, focus_dis = 200, spread = 20, miss_dis = 50, RELOAD_SPEED = 0.9,
		melee_speed = 1, melee_dmg = 8, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.90 }, recoil = { 0.8, 1.0 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.35 }, recoil = { 1.0, 1.5 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.good.mini = {
		aim_delay = { 0.1, 0.2 }, focus_delay = 2, focus_dis = 800, spread = 30, miss_dis = 40, RELOAD_SPEED = 0.5,
		melee_speed = 1, melee_dmg = 25, melee_retry_delay = { 1, 2 }, range = { optimal = 2500, far = 5000, close = 1000 }, autofire_rounds = { 20, 40 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.1, 0.15 }, recoil = { 2.0, 2.0 }, mode = { 0, 0, 0, 1 }, autofire_rounds = { 150, 200 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.02 }, recoil = { 0.5, 0.7 }, mode = { 0, 0, 0, 1 }, autofire_rounds = { 40, 80 } } } }
	presets.weapon.good.is_lmg = {
		aim_delay = { 0.1, 0.1 }, focus_delay = 3, focus_dis = 200, spread = 24, miss_dis = 40, RELOAD_SPEED = 0.66,
		melee_speed = 1, melee_dmg = 13, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, autofire_rounds = presets.weapon.normal.is_lmg.autofire_rounds, FALLOFF = {
		{ dmg_mul = 1.0, r = 1000, acc = { 0.6, 0.6 }, recoil = { 0.3, 0.5 }, mode = { 0, 0, 0, 1 } },
		{ dmg_mul = 1.0, r = 2000, acc = { 0.0, 0.2 }, recoil = { 0.2, 0.4 }, mode = { 0, 0, 0, 1 } } } }
	presets.weapon.good.is_flamethrower = presets.weapon.normal.is_flamethrower
	...
	presets.weapon.expert = {}
	presets.weapon.expert.is_pistol = {
		aim_delay = { 0.1, 0.1 }, focus_delay = 1, focus_dis = 300, spread = 20, miss_dis = 50, RELOAD_SPEED = 1.2,
		melee_speed = 1, melee_dmg = 20, melee_retry_delay = { 1, 2 }, range = presets.weapon.normal.is_pistol.range, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.9 }, recoil = { 0.4, 0.6 }, mode = { 0, 3, 3, 1 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.1, 0.2 }, recoil = { 0.4, 1.4 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.expert.akimbo_pistol = {
		aim_delay = { 0.0, 0.0 }, focus_delay = 1, focus_dis = 300, spread = 20, miss_dis = 50, RELOAD_SPEED = 1.2,
		melee_speed = 1, melee_dmg = 20, melee_retry_delay = { 1, 2 }, range = presets.weapon.normal.is_pistol.range, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.9 }, recoil = { 0.1, 0.2 }, mode = { 0, 3, 3, 1 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.1, 0.2 }, recoil = { 0.4, 1.4 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.expert.is_shotgun_pump = {
		aim_delay = { 0.0, 0.0 }, focus_delay = 2, focus_dis = 200, spread = 15, miss_dis = 20, RELOAD_SPEED = 1,
		melee_speed = 1, melee_dmg = 15, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.9 }, recoil = { 1.0, 1.5 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.3 }, recoil = { 1.5, 2.0 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.expert.is_shotgun_mag = presets.weapon.expert.is_shotgun_pump
	presets.weapon.expert.is_rifle = {
		aim_delay = { 0.0, 0.0 }, focus_delay = 3, focus_dis = 200, spread = 20, miss_dis = 40, RELOAD_SPEED = 1,
		melee_speed = 1, melee_dmg = 15, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, autofire_rounds = presets.weapon.normal.is_rifle.autofire_rounds, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.9 }, recoil = { 0.4, 0.8 }, mode = { 0, 3, 3, 1 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.3 }, recoil = { 1.5, 3.0 }, mode = { 3, 1, 1, 0 } } } }
	presets.weapon.expert.is_bullpup = presets.weapon.expert.is_rifle
	presets.weapon.expert.is_smg = {
		aim_delay = { 0.0, 0.0 }, focus_delay = 2, focus_dis = 200, spread = 15, miss_dis = 10, RELOAD_SPEED = 1.2,
		melee_speed = 1, melee_dmg = 15, melee_retry_delay = { 1, 2 }, range = presets.weapon.normal.is_smg.range, autofire_rounds = presets.weapon.normal.is_smg.autofire_rounds, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.9 }, recoil = { 0.1, 0.2 }, mode = { 0, 3, 3, 1 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.2, 0.3 }, recoil = { 0.5, 1.5 }, mode = { 1, 3, 2, 0 } } } }
	presets.weapon.expert.is_revolver = {
		aim_delay = { 0.0, 0.0 }, focus_delay = 1, focus_dis = 200, spread = 20, miss_dis = 50, RELOAD_SPEED = 0.9,
		melee_speed = 1, melee_dmg = 8, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.9 }, recoil = { 0.8, 1.0 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.3 }, recoil = { 1.0, 1.5 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.expert.mini = {
		aim_delay = { 0.0, 0.0 }, focus_delay = 4, focus_dis = 800, spread = 20, miss_dis = 40, RELOAD_SPEED = 0.5,
		melee_speed = 1, melee_dmg = 25, melee_retry_delay = { 1, 2 }, range = { optimal = 2500, far = 5000, close = 1000 }, autofire_rounds = { 20, 40 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.9 }, recoil = { 0.4, 0.7 }, mode = { 0, 0, 0, 1 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.1, 0.3 }, recoil = { 1.0, 1.2 }, mode = { 4, 2, 1, 0 } } } }
	presets.weapon.expert.is_lmg = {
		aim_delay = { 0.0, 0.0 }, focus_delay = 3, focus_dis = 200, spread = 24, miss_dis = 40, RELOAD_SPEED = 1,
		melee_speed = 1, melee_dmg = 15, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, autofire_rounds = presets.weapon.normal.is_lmg.autofire_rounds, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.6, 0.8 }, recoil = { 0.4, 0.8 }, mode = { 0, 0, 0, 1 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.3 }, recoil = { 1.5, 3.0 }, mode = { 0, 0, 0, 1 } } } }
	presets.weapon.expert.is_flamethrower = presets.weapon.normal.is_flamethrower
	...
	presets.weapon.sniper.is_rifle = {
		aim_delay = { 0.5, 0.5 }, focus_delay = 3, focus_dis = 200, spread = 10, miss_dis = 250, RELOAD_SPEED = 1,
		melee_speed = 1, melee_dmg = 15, melee_retry_delay = { 1, 2 }, range = { optimal = 15000, far = 15000, close = 15000 }, use_laser = false,
		FALLOFF = {
			{ dmg_mul = 1.0, r = 3000, acc = { 0.0, 0.8 }, recoil = { 2, 4 }, mode = { 1, 0, 0, 0 } },
			{ dmg_mul = 1.0, r = 9000, acc = { 0.0, 0.6 }, recoil = { 3, 5 }, mode = { 1, 0, 0, 0 } }
		}
	}
	...
	presets.weapon.deathwish.is_revolver = {
		aim_delay = { 0, 0 }, focus_delay = 10, focus_dis = 200, spread = 20, miss_dis = 50, RELOAD_SPEED = 0.9,
		melee_speed = 1, melee_dmg = 8, melee_retry_delay = { 1, 2 }, range = { optimal = 2000, far = 5000, close = 1000 }, 
		FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.70, 0.90 }, recoil = { 0.80, 1.00 }, mode = { 1, 	0, 	0, 	0 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.10, 0.35 }, recoil = { 1.00, 1.50 }, mode = { 1, 	0, 	0, 	0 } } } }
	presets.weapon.deathwish.is_pistol = {
		aim_delay = { 0, 0 }, focus_delay = 0, focus_dis = 200, spread = 20, miss_dis = 50, RELOAD_SPEED = 1.4,
		melee_speed = 1, melee_dmg = 20, melee_retry_delay = { 1, 2 }, range = { optimal = 3200, far = 5000, close = 2000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.90, 0.95 }, recoil = { 0.4, 0.6 }, mode = { 0, 3, 3, 1 } },
		{ dmg_mul = 1.0, r = 4000, acc = { 0.20, 0.65 }, recoil = { 1.00, 1.50 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.deathwish.is_rifle = {
		aim_delay = { 0, 0 }, focus_delay = 0, focus_dis = 200, spread = 20, miss_dis = 40, RELOAD_SPEED = 1.4,
		melee_speed = 1, melee_dmg = 20, melee_retry_delay = { 1, 2 }, range = { optimal = 3500, far = 6000, close = 2000 }, autofire_rounds = { 4, 9 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.90, 0.97 }, recoil = { 0.25, 0.30 }, mode = { 0, 3, 3, 1 } },
		{ dmg_mul = 1.0, r = 6000, acc = { 0.25, 0.70 }, recoil = { 1.00, 2.00 }, mode = { 3, 1, 1, 0 } } } }
	presets.weapon.deathwish.is_bullpup = presets.weapon.deathwish.is_rifle
	presets.weapon.deathwish.is_shotgun_pump = {
		aim_delay = { 0, 0 }, focus_delay = 0, focus_dis = 200, spread = 15, miss_dis = 20, RELOAD_SPEED = 1.4,
		melee_speed = 1, melee_dmg = 20, melee_retry_delay = { 1, 2 }, range = { optimal = 3000, far = 5000, close = 2000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.95, 0.95 }, recoil = { 1.00, 1.10 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.30, 0.50 }, recoil = { 1.50, 1.75 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.deathwish.is_shotgun_mag = presets.weapon.deathwish.is_shotgun_pump
	presets.weapon.deathwish.is_smg = {
		aim_delay = { 0, 0 }, focus_delay = 0, focus_dis = 200, spread = 15, miss_dis = 10, RELOAD_SPEED = 1.4,
		melee_speed = 1, melee_dmg = 20, melee_retry_delay = { 1, 2 }, range = { optimal = 3200, far = 6000, close = 2000 }, autofire_rounds = { 8, 16 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.95, 0.95 }, recoil = { 0.10, 0.25 }, mode = { 0, 3, 3, 4 } },
		{ dmg_mul = 1.0, r = 4500, acc = { 0.30, 0.60 }, recoil = { 1.00, 1.50 }, mode = { 1, 3, 2, 0 } } } }
	presets.weapon.deathwish.mini = {
		aim_delay = { 0.1, 0.2 }, focus_delay = 4, focus_dis = 800, spread = 20, miss_dis = 40, RELOAD_SPEED = 0.5,
		melee_speed = 1, melee_dmg = 25, melee_retry_delay = { 1, 2 }, range = { optimal = 2500, far = 5000, close = 1000 }, autofire_rounds = { 20, 40 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.60, 0.90 }, recoil = { 0.40, 0.70 }, mode = { 0, 0, 0, 1 } },
		{ dmg_mul = 1.0, r = 3000, acc = { 0.10, 0.35 }, recoil = { 1.00, 1.20 }, mode = { 4, 2, 1, 0 } } } }
	presets.weapon.deathwish.is_lmg = {
		aim_delay = { 0, 0 }, focus_delay = 0, focus_dis = 200, spread = 24, miss_dis = 40, RELOAD_SPEED = 0.75,
		melee_speed = 1, melee_dmg = 20, melee_retry_delay = { 1, 2 }, range = { optimal = 3500, far = 6000, close = 2000 }, autofire_rounds = { 25, 50 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.80, 0.90 }, recoil = { 0.25, 0.30 }, mode = { 0, 0, 0, 1 } },
		{ dmg_mul = 1.0, r = 6000, acc = { 0.10, 0.20 }, recoil = { 1.00, 2.00 }, mode = { 0, 0, 0, 1 } } } }
	presets.weapon.deathwish.is_flamethrower = presets.weapon.normal.is_flamethrower
	...
	presets.weapon.easywish.is_pistol = {
		...
		melee_speed = 1, melee_dmg = 20, melee_retry_delay = { 1, 2 }, range = { optimal = 3200, far = 5000, close = 2000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.90, 0.95 }, recoil = { 0.4, 0.6 }, mode = { 0, 3, 3, 1 } }, 
		{ dmg_mul = 1.0, r = 5000, acc = { 0.10, 0.50 }, recoil = { 0.40, 1.00 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.easywish.is_rifle = {
		aim_delay = { 0, 0 }, focus_delay = 0, focus_dis = 200, spread = 20, miss_dis = 40, RELOAD_SPEED = 1.4,
		melee_speed = 1, melee_dmg = 20, melee_retry_delay = { 1, 2 }, range = { optimal = 3500, far = 6000, close = 2000 }, autofire_rounds = { 4, 9 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.60, 0.90 }, recoil = { 0.25, 0.30 }, mode = { 0, 3, 3, 1 } }, 
		{ dmg_mul = 1.0, r = 6000, acc = { 0.01, 0.35 }, recoil = { 1.00, 2.00 }, mode = { 3, 1, 1, 0 } } } }
	presets.weapon.easywish.is_bullpup = presets.weapon.easywish.is_rifle
	presets.weapon.easywish.is_shotgun_pump = {
		aim_delay = { 0, 0 }, focus_delay = 0, focus_dis = 200, spread = 15, miss_dis = 20, RELOAD_SPEED = 1.4,
		melee_speed = 1, melee_dmg = 20, melee_retry_delay = { 1, 2 }, range = { optimal = 3000, far = 5000, close = 2000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.60, 0.90 }, recoil = { 1.00, 1.10 }, mode = { 1, 0, 0, 0 } }, 
		{ dmg_mul = 1.0, r = 3000, acc = { 0.20, 0.75 }, recoil = { 1.50, 1.75 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.easywish.is_shotgun_mag = presets.weapon.easywish.is_shotgun_pump
	presets.weapon.easywish.is_smg = {
		aim_delay = { 0, 0 }, focus_delay = 0, focus_dis = 200, spread = 15, miss_dis = 10, RELOAD_SPEED = 1.4,
		melee_speed = 1, melee_dmg = 20, melee_retry_delay = { 1, 2 }, range = { optimal = 3200, far = 6000, close = 2000 }, autofire_rounds = { 8, 16 }, FALLOFF = {
	...
	presets.weapon.easywish.mini = {
		...
		{ dmg_mul = 1.0, r = 3000, acc = { 0.10, 0.35 }, recoil = { 1.00, 1.20 }, mode = { 4, 2, 1, 0 } } } }
	presets.weapon.easywish.is_lmg = {
		aim_delay = { 0, 0 }, focus_delay = 0, focus_dis = 200, spread = 20, miss_dis = 40, RELOAD_SPEED = 0.7,
		melee_speed = 1, melee_dmg = 20, melee_retry_delay = { 1, 2 }, range = { optimal = 3500, far = 6000, close = 2000 }, autofire_rounds = { 25, 40 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 0.70, 0.80 }, recoil = { 0.25, 0.30 }, mode = { 0, 0, 0, 1 } },
		{ dmg_mul = 1.0, r = 6000, acc = { 0.01, 0.20 }, recoil = { 1.00, 2.00 }, mode = { 0, 0, 0, 1 } } } }
	presets.weapon.easywish.is_flamethrower = presets.weapon.normal.is_flamethrower
	...
	presets.weapon.gang_member.is_pistol = {
		aim_delay = { 0, 0.5 }, focus_delay = 1, focus_dis = 200, spread = 25, miss_dis = 20, RELOAD_SPEED = 1.5,
		melee_speed = 3, melee_dmg = 3, melee_retry_delay = { 1, 2 }, range = presets.weapon.normal.is_pistol.range,
		FALLOFF = {
		{ dmg_mul = 1.0, r = 300 , acc = { 1.00, 1.00 }, recoil = { 0.4, 0.6 }, mode = { 0.1, 0.3, 4, 7 } },
		{ dmg_mul = 1.0, r = 500, acc = { 1.00, 1.00 }, recoil = { 2.00, 3.00 }, mode = { 0.1, 0.3, 4, 7 } } } }
	presets.weapon.gang_member.is_rifle = {
		aim_delay = { 0, 0.5 }, focus_delay = 1, focus_dis = 300, spread = 25, miss_dis = 10, RELOAD_SPEED = 1,
		melee_speed = 2, melee_dmg = 3, melee_retry_delay = { 1, 2 }, range = { optimal = 2500, far = 6000, close = 1500 }, autofire_rounds = presets.weapon.normal.is_rifle.autofire_rounds, FALLOFF = {
		{ dmg_mul = 1.0, r = 300 , acc = { 1.00, 1.00 }, recoil = { 0.25, 0.45 }, mode = { 0.1, 0.3, 4, 7 } },
		{ dmg_mul = 1.0, r = 500, acc = { 1.00, 1.00 }, recoil = { 2.00, 3.00 }, mode = { 0.1, 0.3, 4, 7 } } } }
	presets.weapon.gang_member.is_sniper = {
		aim_delay = { 0.25, 1 }, focus_delay = 1, focus_dis = 300, spread = 25, miss_dis = 10, RELOAD_SPEED = 1,
		melee_speed = 2, melee_dmg = 3, melee_retry_delay = { 1, 2 }, range = { optimal = 4000, far = 6000, close = 2000 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500 , acc = { 1.00, 1.00 }, recoil = { 1.00, 1.00 }, mode = { 1, 0, 0, 0 } },
		{ dmg_mul = 1.0, r = 500, acc = { 0.85, 0.90 }, recoil = { 1.00, 1.00 }, mode = { 1, 0, 0, 0 } } } }
	presets.weapon.gang_member.is_lmg = {
		aim_delay = { 0, 0.5 }, focus_delay = 1, focus_dis = 300, spread = 30, miss_dis = 10, RELOAD_SPEED = 0.7,
		melee_speed = 2, melee_dmg = 3, melee_retry_delay = { 1, 2 }, range = { optimal = 2500, far = 6000, close = 1500 }, autofire_rounds = presets.weapon.normal.is_lmg.autofire_rounds, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 1.00, 1.00 }, recoil = { 0.25, 0.45 }, mode = { 0, 0, 0, 1 } },
		{ dmg_mul = 1.0, r = 500, acc = { 0.01, 0.10 }, recoil = { 2.00, 3.00 }, mode = { 0, 0, 0, 1 } } } }
	presets.weapon.gang_member.is_shotgun_pump = {
		aim_delay = { 0, 0.25 }, focus_delay = 1, focus_dis = 200, spread = 15, miss_dis = 10, RELOAD_SPEED = 2,
		melee_speed = 2, melee_dmg = 3, melee_retry_delay = { 1, 2 }, range = presets.weapon.normal.is_shotgun_pump.range, FALLOFF = {
		{ dmg_mul = 1.0, r = 300 , acc = { 1.00, 1.00 }, recoil = { 0.25, 0.45 }, mode = { 0.1, 0.3, 4, 7 } },
		{ dmg_mul = 1.0, r = 500, acc = { 1.00, 1.00 }, recoil = { 2.00, 3.00 }, mode = { 0.1, 0.3, 4, 7 } } } }
	presets.weapon.gang_member.is_shotgun_mag = {
		aim_delay = { 0, 0.25 }, focus_delay = 1, focus_dis = 200, spread = 18, miss_dis = 10, RELOAD_SPEED = 1.6,
		melee_speed = 2, melee_dmg = 3, melee_retry_delay = { 1, 2 }, range = presets.weapon.normal.is_shotgun_mag.range, autofire_rounds = { 4, 8 }, FALLOFF = {
		{ dmg_mul = 1.0, r = 500, acc = { 1.00, 1.00 }, recoil = { 0.10, 0.10 }, mode = { 1, 1, 4, 6 } },
		{ dmg_mul = 1.0, r = 500, acc = { 0.05, 0.20 }, recoil = { 0.50, 1.00 }, mode = { 2, 1, 0, 0 } } } }
	presets.weapon.gang_member.is_smg = presets.weapon.gang_member.is_rifle
	presets.weapon.gang_member.is_revolver = presets.weapon.gang_member.is_pistol
	presets.weapon.gang_member.is_bullpup = presets.weapon.gang_member.is_rifle
	presets.weapon.gang_member.mac11 = presets.weapon.gang_member.is_smg
	...
	presets.detection.blind = { idle = {}, combat = {}, recon = {}, guard = {}, ntl = {} }
	presets.detection.blind.idle.dis_max = 1
	presets.detection.blind.idle.angle_max = 0
	...
	presets.dodge = {
		poor = { speed = 0.9, occasions = {
			hit = { chance = 0.9, check_timeout = { 0, 0 }, variations = {
				side_step = { chance = 1, timeout = { 2, 3 } } } },
			scared = { chance = 0.5, check_timeout = { 1, 2 }, variations = {
				side_step = { chance = 1, timeout = { 2, 3 } } } } } },

		average = { speed = 1, occasions = {
			hit = { chance = 0.3, check_timeout = { 0, 0 }, variations = {
				side_step = { chance = 1, timeout = { 2, 3 } } } },
			scared = { chance = 0.4, check_timeout = { 4, 7 }, variations = {
				dive = 		{ chance = 1, timeout = { 5, 8 } } } } } },

		heavy = { speed = 1, occasions = {
			hit = { chance = 0.7, check_timeout = { 0, 0 }, variations = {
				side_step = { chance = 9, shoot_chance = 0.8, shoot_accuracy = 0.5, timeout = { 0, 7 } },
				roll = 		{ chance = 1, timeout = { 8, 10 } } } },
			preemptive = { chance = 0.1, check_timeout = { 1, 7 }, variations = {
				side_step = { chance = 1, shoot_chance = 1, shoot_accuracy = 0.7, timeout = { 1, 7 } } } },
			scared = { chance = 0.8, check_timeout = { 1, 2 }, variations = {
				side_step = { chance = 5, shoot_chance = 0.5, shoot_accuracy = 0.4, timeout = { 1, 2 } },
				roll = 		{ chance = 1, timeout = { 8, 10 } },
				dive = 		{ chance = 2, timeout = { 8, 10 } } } } } },

		athletic = { speed = 1.3, occasions = {
			hit = { chance = 0.9, check_timeout = { 0, 0 }, variations = {
				side_step = { chance = 5, shoot_chance = 0.8, shoot_accuracy = 0.5, timeout = { 1, 3 } },
				roll = 		{ chance = 1, timeout = { 3, 4 } } } },
			preemptive = { chance = 0.35, check_timeout = { 2, 3 }, variations = {
				side_step = { chance = 3, shoot_chance = 1, shoot_accuracy = 0.7, timeout = { 1, 2 } },
				roll = 		{ chance = 1, timeout = { 3, 4 } } } },
			scared = { chance = 0.4, check_timeout = { 1, 2 }, variations = {
				side_step = { chance = 5, shoot_chance = 0.5, shoot_accuracy = 0.4, timeout = { 1, 2 } },
				roll = 		{ chance = 3, timeout = { 3, 5 } },
				dive = 		{ chance = 1, timeout = { 3, 5 } } } } } },

		ninja = { speed = 2.0, occasions = {
			hit = { chance = 0.9, check_timeout = { 0, 3 }, variations = {
				side_step = { chance = 3, shoot_chance = 1, shoot_accuracy = 0.7, timeout = { 1, 2 } },
				roll = 		{ chance = 1, timeout = { 1.2, 2 } },
				wheel = 	{ chance = 2, timeout = { 1.2, 2 } } } },
			preemptive = { chance = 0.6, check_timeout = { 0, 3 }, variations = {
				side_step = { chance = 3, shoot_chance = 1, shoot_accuracy = 0.8, timeout = { 1, 2 } },
				roll = 		{ chance = 1, timeout = { 1.2, 2 } },
				wheel = 	{ chance = 2, timeout = { 1.2, 2 } } } },
			scared = { chance = 0.9, check_timeout = { 	0, 	3 }, variations = {
				side_step = { chance = 5, shoot_chance = 0.8, shoot_accuracy = 0.6, timeout = { 1, 2 } },
				roll = 		{ chance = 3, timeout = { 1.2, 2 } },
				wheel = 	{ chance = 3, timeout = { 1.2, 2 } },
	...
	presets.move_speed = {
		civ_fast = {
			stand = {
				walk = { ntl = { strafe=120, fwd=150, bwd=100 }, hos = { strafe=190, fwd=210, bwd=160 }, cbt = { strafe=175, fwd=210, bwd=160 } },
				run  = { hos = { strafe=192, fwd=500, bwd=230 }, cbt = { strafe=250, fwd=500, bwd=230 } } },
			crouch = {
				walk = { hos = { strafe=160, fwd=174, bwd=163 }, cbt = { strafe=160, fwd=174, bwd=163 } },
				run  = { hos = { strafe=245, fwd=312, bwd=260 }, cbt = { strafe=245, fwd=312, bwd=260 } } }
		},

		lightning = {
			stand = {
				walk = { ntl = { strafe=120, fwd=150, bwd=110 }, hos = { strafe=225, fwd=285, bwd=215 }, cbt = { strafe=225, fwd=285, bwd=215 } },
				run  = { hos = { strafe=400, fwd=800, bwd=350 }, cbt = { strafe=380, fwd=750, bwd=320 } } },
			crouch = {
				walk = { hos = { strafe=210, fwd=245, bwd=190 }, cbt = { strafe=190, fwd=255, bwd=190 } },
				run  = { hos = { strafe=300, fwd=420, bwd=250 }, cbt = { strafe=300, fwd=412, bwd=280 } } }
		},

		extremely_slow = {
			stand = {
				walk = { ntl = { strafe = 60, fwd = 72, bwd = 56 }, hos = { strafe = 60, fwd = 72, bwd = 56 }, cbt = { strafe = 60, fwd = 72, bwd = 56 } },
				run = { hos = { strafe = 70, fwd = 72, bwd = 56 }, cbt = { strafe = 50, fwd = 72, bwd = 60 } } },
			crouch = {
				walk = { hos = { strafe = 60, fwd = 72, bwd = 56 }, cbt = { strafe = 60, fwd = 72, bwd = 56 } },
				run = { hos = { strafe = 65, fwd = 72, bwd = 56 }, cbt = { strafe = 50, fwd = 72, bwd = 60 } } }
		},

		very_slow = {
			stand = {
				walk = { ntl = { strafe=120, fwd=144, bwd=113 }, hos = { strafe=120, fwd=144, bwd=113 }, cbt = { strafe=120, fwd=144, bwd=113 } },
				run  = { hos = { strafe=140, fwd=144, bwd=113 }, cbt = { strafe=100, fwd=144, bwd=125 } } },
			crouch = {
				walk = { hos = { strafe=120, fwd=144, bwd=113 }, cbt = { strafe=120, fwd=144, bwd=113 } },
				run  = { hos = { strafe=130, fwd=144, bwd=113 }, cbt = { strafe=100, fwd=144, bwd=125 } } }
		},

		slow = {
			stand = {
				walk = { ntl = { strafe=120, fwd=144, bwd=113 }, hos = { strafe=120, fwd=144, bwd=113 }, cbt = { strafe=120, fwd=144, bwd=113 } },
				run  = { hos = { strafe=150, fwd=360, bwd=135 }, cbt = { strafe=150, fwd=360, bwd=155 } } },
			crouch = {
				walk = { hos = { strafe=120, fwd=144, bwd=113 }, cbt = { strafe=120, fwd=144, bwd=113 } },
				run  = { hos = { strafe=140, fwd=360, bwd=150 }, cbt = { strafe=140, fwd=360, bwd=155 } } }
		},

		normal = {
			stand = {
				walk = { ntl = { strafe=120, fwd=150, bwd=100 }, hos = { strafe=190, fwd=220, bwd=170 }, cbt = { strafe=190, fwd=220, bwd=170 } },
				run  = { hos = { strafe=290, fwd=450, bwd=255 }, cbt = { strafe=250, fwd=400, bwd=255 } } },
			crouch = {
				walk = { hos = { strafe=170, fwd=210, bwd=160 }, cbt = { strafe=170, fwd=210, bwd=160 } },
				run  = { hos = { strafe=260, fwd=310, bwd=235 }, cbt = { strafe=260, fwd=350, bwd=235 } } }
		},

		fast = {
			stand = {
				walk = { ntl = { strafe=120, fwd=150, bwd=110 }, hos = { strafe=215, fwd=270, bwd=185 }, cbt = { strafe=215, fwd=270, bwd=185 } },
				run  = { hos = { strafe=315, fwd=625, bwd=280 }, cbt = { strafe=285, fwd=450, bwd=280 } } },
			crouch = {
				walk = { hos = { strafe=180, fwd=235, bwd=170 }, cbt = { strafe=180, fwd=235, bwd=170 } },
				run  = { hos = { strafe=280, fwd=330, bwd=255 }, cbt = { strafe=270, fwd=312, bwd=255 } } }
		},

		very_fast = {
			stand = {
				walk = { ntl = { strafe=120, fwd=150, bwd=110 }, hos = { strafe=225, fwd=285, bwd=215 }, cbt = { strafe=225, fwd=285, bwd=215 } },
				run  = { hos = { strafe=340, fwd=670, bwd=325 }, cbt = { strafe=325, fwd=475, bwd=300 } } },
			crouch = {
				walk = { hos = { strafe=210, fwd=245, bwd=190 }, cbt = { strafe=190, fwd=255, bwd=190 } },
				run  = { hos = { strafe=282, fwd=350, bwd=268 }, cbt = { strafe=282, fwd=312, bwd=268 } } }
		}
	}
	...
	presets.surrender = {
		...
		never = { base_chance = 0, impossible = true },
		easy = { base_chance = 0.3, significant_chance = 0.35,
			reasons = { pants_down = 1, isolated = 0, weapon_down = 1, health = { [1.0] = 0, [0.999] = 0 } },
			factors = { unaware_of_aggressor = 0.1, enemy_weap_cold = 0, flanked = 1, aggressor_dis = { [100.0] = 0.2, [300.0] = 0 } } },
		normal = { base_chance = 0.3, significant_chance = 0.35,
			reasons = { health = { [1.0] = 0.1, [0.999] = 0.9 } },
			factors = {} },
		hard = { base_chance = 0.35, significant_chance = 0.25, violence_timeout = 2,
			reasons = { pants_down = 0.8, weapon_down = 0.2, health = { [1.0] = 0, [0.35] = 0.5 } },
	...
	presets.suppression = {
		easy = {
			panic_chance_mul = 0.0, duration = { 10, 15 }, react_point = { 0, 2 }, brown_point = { 3, 5 } },
		hard_def = {
			panic_chance_mul = 0.0, duration = { 5, 10 }, react_point = { 0, 2 }, brown_point = { 5, 6 } },
		hard_agg = {
			panic_chance_mul = 0.0, duration = { 5, 8 }, react_point = { 2, 5 }, brown_point = { 5, 6 } },
		no_supress = {
			panic_chance_mul = 0.0, duration = { 0.1, 0.15 }, react_point = { 100, 200 }, brown_point = { 400, 500 } }
	}
	...
	presets.enemy_chatter = {
		no_chatter = {},
		cop = { retreat = true, suppress = true },
		swat = { clear = true, ready = true, contact = true, suppress = true, smoke = true, retreat = true, go_go = true, aggressive = true, follow_me = true },
...
Hooks:PostHook( CharacterTweakData, "init", "nqr_CharacterTweakData:init", function(self, tweak_data)
	local presets = self:_presets(tweak_data)
	local standard_health = 50
	local boss_health = standard_health * 1.6

	for i, k in pairs(self) do
		if type(k)=="table" and k.HEALTH_INIT then
			k.HEALTH_INIT = standard_health
			k.damage.explosion_damage_mul = 1
			k.DAMAGE_CLAMP_BULLET = nil
			k.DAMAGE_CLAMP_EXPLOSION = nil
			k.melee_weapon_dmg_multiplier = 1

			k.ammo = k.ammo or { 1, 0 }
			k.armor = k.armor or { body=0, head={0, 0}, face={0, 0}, back=0, lower_legs=0, upper_legs=0, lower_arm=0, upper_arm=0 }
		end
	end

	self.civilian.HEALTH_INIT = standard_health * 0.5
	self.tank.HEALTH_INIT = standard_health * 1.2
	self.phalanx_minion.HEALTH_INIT = standard_health * 1.2
	self.tank_hw.HEALTH_INIT = standard_health * 0.8
	self.triad_boss.HEALTH_INIT = boss_health
	self.deep_boss.HEALTH_INIT = boss_health
	self.drug_lord_boss.HEALTH_INIT = boss_health
	self.biker_boss.HEALTH_INIT = boss_health
	self.hector_boss.HEALTH_INIT = boss_health
	self.mobster_boss.HEALTH_INIT = boss_health
	self.chavez_boss.HEALTH_INIT = boss_health

	self.security.ammo =				{ 1, 0 }
	self.security.armor =				{ body=1, back=1, head={0, 0.0, 0.0}, face={0, 0.0}, lower_legs=0, upper_legs=0, lower_arm=0, upper_arm=0 }
	self.cop.ammo =						{ 1, 0 }
	self.cop.armor =					{ body=1, back=1, head={0, 0.0, 0.0}, face={0, 0.0}, lower_legs=0, upper_legs=0, lower_arm=0, upper_arm=0 }
	self.gensec.ammo =					{ 1, 0 }
	self.gensec.armor =					{ body=1, back=1, head={0, 0.0, 0.0}, face={0, 0.0}, lower_legs=0, upper_legs=0, lower_arm=0, upper_arm=0 }
	self.fbi.ammo =						{ 1, 0 }
	self.fbi.armor =					{ body=1, back=1, head={0, 0.0, 0.0}, face={0, 0.0}, lower_legs=0, upper_legs=0, lower_arm=0, upper_arm=0 }
	...
	self.marshal_marksman.armor = 		{ body=2, back=1, head={0, 0.0, 0.0}, face={1, 0.8}, lower_legs=0, upper_legs=0, lower_arm=0, upper_arm=0 }
	self.marshal_shield.ammo = 			{ 3, 2 }
	self.marshal_shield.armor = 		{ body=3, back=3, head={2, 0.3, 0.9}, face={1, 0.5}, lower_legs=0, upper_legs=0, lower_arm=0, upper_arm=0 }
	self.marshal_shield_break.ammo = 	{ 3, 2 }
	self.marshal_shield_break.armor = 	{ body=3, back=3, head={2, 0.3, 0.9}, face={1, 0.5}, lower_legs=0, upper_legs=0, lower_arm=0, upper_arm=0 }
	self.tank.ammo =					{ 3, 0 }
	self.tank.armor =					{ whole_body=3,   head={4, 0.2, 2.0}, face={0, 0.0}, lower_legs=0, upper_legs=0, lower_arm=0, upper_arm=0 }
	self.tank_hw.ammo =					{ 3, 0 }
	...
	self.triad_boss.armor = 			{ whole_body=3,   head={3, 2.0, 2.0}, face={0, 0.0}, lower_legs=0, upper_legs=0, lower_arm=0, upper_arm=0 }
	self.deep_boss.ammo = 				{ 3, 0 }
	self.deep_boss.armor = 				{ whole_body=3,   head={4, 2.0, 2.0}, face={0, 0.0}, lower_legs=0, upper_legs=0, lower_arm=0, upper_arm=0 }
	...
	self.chavez_boss.armor = 			{ body=3, back=3, head={0, 0.0, 0.0}, face={0, 0.0}, lower_legs=0, upper_legs=0, lower_arm=0, upper_arm=0 }



	for i, k in pairs(self) do
		if type(k)=="table" and k.HEALTH_INIT then
			if not k.weight then
				k.weight = 20
				for o, l in pairs(k.armor) do k.weight = k.weight + (o=="whole_body" and l*10 or (type(l)=="table" and l[1] or l*2)) end
			end

			if k.damage.explosion_damage_mul then
				k.damage.explosion_damage_mul = k.armor.whole_body and 0.1 or (k.damage.explosion_damage_mul/(k.armor.body+1))
				if k.access=="shield" then k.damage.explosion_damage_mul = k.damage.explosion_damage_mul/4 end
			end
		end
	end
	...
	self.taser.weapon.is_rifle.tase_sphere_cast_radius = 18
	self.taser.weapon.is_rifle.tase_distance = 1000
	self.taser.weapon.is_rifle.aim_delay_tase = { 1, 1 }

	self.tank_hw = deep_clone(self.tank)
	self.tank_hw.weapon.mini = deep_clone(self.tank_mini.weapon.mini)
	self.tank_hw.weapon.mini.aim_delay = { 0.2, 0.4 }
	self.tank_hw.weapon.mini.RELOAD_SPEED = 100
	self.tank_hw.weapon.mini.FALLOFF[1].autofire_rounds = { 5, 10 }
	self.tank_hw.weapon.mini.FALLOFF[2].autofire_rounds = { 5, 10 }
	self.tank_hw.weapon.mini.FALLOFF[3].autofire_rounds = { 5, 10 }
	self.tank_hw.weapon.mini.FALLOFF[4].autofire_rounds = { 5, 10 }
	self.tank_hw.weapon.mini.FALLOFF[5].autofire_rounds = { 5, 10 }
	self.tank_hw.weapon.mini.melee_speed = 0.5
	--self.tank_hw.move_speed = presets.move_speed.extremely_slow
	--self.tank_hw.HEALTH_INIT = 200
	self.tank_hw.ignore_headshot = true
	...
	--table.insert(self.weap_unit_names, Idstring("units/pd2_dlc_gage_lmg/weapons/wpn_fps_lmg_hk21/wpn_fps_lmg_hk21_npc"))
...
Hooks:PostHook( CharacterTweakData, "_init_shield", "nqr_CharacterTweakData:_init_shield", function(self, presets)
	...
	self.shield.weapon.is_smg.aim_delay = { 0.2, 0.6 }
end)
...
Hooks:PostHook( CharacterTweakData, "_init_spooc", "nqr_CharacterTweakData:_init_spooc", function(self, presets)
	self.spooc.damage.hurt_severity = presets.hurt_severities.base
	self.spooc.spawn_sound_event = nil
end)

Hooks:PostHook( CharacterTweakData, "_init_medic", "nqr_CharacterTweakData:_init_medic", function(self, presets)
...
--[[function CharacterTweakData:_init_tank(presets)
	...
	self.tank.weapon.is_shotgun_pump.RELOAD_SPEED = 1
	self.tank.weapon.is_shotgun_mag.autofire_rounds = { 1, 4 }
	...
	self.tank.ecm_vulnerability = 0.85
	self.tank.ecm_hurts = {
		ears = { max_duration = 3, min_duration = 1 } }
	self.tank.weapon_voice = "3"
	self.tank.experience.cable_tie = "tie_swat"
	self.tank.access = "tank"
	self.tank.speech_prefix_p1 = self._prefix_data_p1.bulldozer()
	...
	self.tank.can_be_tased = false
	self.tank.chatter = { retreat = true, aggressive = true, contact = true }
	self.tank.announce_incomming = "incomming_tank"
	self.tank.kill_taunt = "post_kill_taunt"
	self.tank.steal_loot = nil
	self.tank.calls_in = nil
...
Hooks:PostHook( CharacterTweakData, "_init_tank", "nqr_CharacterTweakData:_init_tank", function(self, presets)
	--self.tank.damage.immune_to_knockback = false
	...
	self.tank.move_speed = {
		stand = {
			walk = {
				ntl = { strafe = 100, fwd = 140, bwd = 56 },
				hos = { strafe = 100, fwd = 140, bwd = 56 },
				cbt = { strafe = 100, fwd = 140, bwd = 56 } },
			run = {
				hos = { strafe = 120, fwd = 210, bwd = 56 },
				cbt = { strafe = 120, fwd = 210, bwd = 60 } } },
		crouch = {
			walk = {
				hos = { strafe = 60, fwd = 72, bwd = 56 },
				cbt = { strafe = 60, fwd = 72, bwd = 56 } },
			run = {
				hos = { strafe = 65, fwd = 72, bwd = 56 },
				cbt = { strafe = 50, fwd = 72, bwd = 60 } } } }
	self.tank.weapon = deep_clone(presets.weapon.normal)
	self.tank.weapon.is_lmg.autofire_rounds = { 4, 8 }
	self.tank.weapon.is_lmg.RELOAD_SPEED = 0.5
end)

Hooks:PostHook( CharacterTweakData, "_init_deep_boss", "nqr_CharacterTweakData:_init_deep_boss", function(self, presets)
	self.deep_boss.move_speed = presets.move_speed.very_slow
	self.deep_boss.damage.hurt_severity = presets.hurt_severities.only_light_hurt
	self.deep_boss.weapon.is_lmg.autofire_rounds = { 4, 8 }
end)

Hooks:PostHook( CharacterTweakData, "_init_triad_boss", "nqr_CharacterTweakData:_init_triad_boss", function(self, presets)
