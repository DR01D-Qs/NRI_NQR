Hooks:PostHook(GroupAITweakData, "_init_task_data", "nqr_GroupAITweakData:_init_task_data", function(self, difficulty_index, difficulty)
	...
	local job_mapping = {
		crojob2 = {1.4,2}, --bomb dockyard +
		crojob3 = {1.5,2}, --bomb forest +
		friend = {1.1,2.5}, --scarface mansion +
		dah = {1,2}, --diamond heist +
		peta = {1.5,1.5}, --goatsim 1 +
		peta2 = {1,2}, --goats day 2 +
		welcome_to_the_jungle_1 = {1.4,1.5}, --big oil 1
		welcome_to_the_jungle_1_night = {1.4,1.5}, --big oil 1
		...
		pbr = {0.9,2}, --beneath the mountain
		...
		firestarter_3 = {1.6,1.5}, --firestarter 3 +
		mex = {1.2,2}, --border crossing +
		mex_cooking = {0.8,1.5}, --border crystals
		roberts = {1.4,2}, --go bank +
		...
		vit = {0.9,1.5}, --white house +
		mia_1 = {2,2}, --hotline miami 1
		mia_2 = {1,1.5}, --hotline miami 2
		nail = {1.0,2.5},	--lab rats
		...
		gallery = {1.2,2}, --art gallery
		alex_1 = {1.4,2}, --rats 1 +
		alex_2 = {1.2,1.5}, --rats 2
		alex_3 = {2,2}, --rats 3 +
		election_day_1 = {1.3,2}, --election +
		election_day_2 = {1.4,2}, --election day 2
		...
		escape_cafe_day = {0.5,1.5}, --escape cafe
		escape_park = {0.5,1.5}, --escape park
		escape_park_day = {0.5,1.5}, --escape park
		escape_overpass = {0.5,1.5}, --escape overpass
		escape_overpass_night = {0.5,1.5}, --escape overpass
		...
		ranc = {2,1.5}, --midland ranch
		trai = {2,2}, --lost in transit
		framing_frame_1 = {1.2,2.5}, --ff1
		framing_frame_2 = {1,1.5}, --ff2
		framing_frame_3 = {1.2,1.5}, --ff3
		corp = {3,1.5}, --hostile takeover
		shoutout_raid = {1.2,2.5}, --meltdown
		pex = {1.5,1.5}, --policia federale
		deep = {1.2,2}, --crude awakening
		nightclub = {1.5,1}, --nightclub
		...
		arm_cro = {1.2,2}, --transport crossroads
		arm_fac = {1.2,2}, --transport harbor
		arm_hcm = {1.2,2}, --transport downtown
		arm_for = {1.2,2}, --transport train
		arena = {1.1,1.5}, --alesso
		wwh = {1,1.5}, --alaskan deal
		chca = {1.3,2}, --black cat +
		mad = {1.2,1}, --boiling point
		kenaz = {1.2,2}, --golden grin casino
		pal = {1.5,2}, --counterfeit +-
		red2 = {0.9,2}, --first world bank +
	}
	local custom_force = {
		mia_2 = {2,1.3},
		friend = {2,1.3},
	...
	if difficulty_index <= 2 then
		self.besiege.assault.force = { 2*force_mul*custom_force[1], 4*force_mul*custom_force[2], 6*force_mul }
