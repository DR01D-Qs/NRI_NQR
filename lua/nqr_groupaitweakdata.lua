Hooks:PostHook(GroupAITweakData, "_init_task_data", "nqr_GroupAITweakData:_init_task_data", function(self, difficulty_index, difficulty)
	...
	local job_mapping = {
		...
		rvd1 = {1.2,1.5}, --reservoir dogs 1
		rvd2 = {1.2,2.5}, --reservoir dogs 2
		vit = {0.9,1.5}, --white house
		mia_1 = {1.4,2.5}, --hotline miami 1
		mia_2 = {1.1,1.5}, --hotline miami 2
		nail = {0.8,2.5},	--lab rats
		hox_1 = {0.6,1}, --hoxton breakout 1
		...
		escape_overpass = {0.6,1.5}, --escape overpass
		...
		kenaz = {1,2}, --golden grin casino
		pal = {1.4,2}, --counterfeit
